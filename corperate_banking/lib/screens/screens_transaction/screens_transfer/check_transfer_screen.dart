  ...
  Future<void> transfNow() async {
    ...
    TransfSingleCreatedOrderSuccessRequest request =
        TransfSingleCreatedOrderSuccessRequest(
            recipient_Account_Type: "บัญชีออมทรัพย์",
            ...
            recipient_account_No_name_Th: toFName + ' ' + toLName,
            sender_Account_No: fromAcctNumber,
            sender_Account_Type: fromAcctType,
            sender_account_No_name: fromAcctName,
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            width: _width * 0.2,
                            child: CircleAvatar(
                              backgroundImage: checkLogoBank(fromBankName),
