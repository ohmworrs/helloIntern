...
class _TransactionScreenState extends State<TransactionScreen> {
    ...
    try {
      ...
      print(data);
       Navigator.push(context, MaterialPageRoute(
         builder: (context) => ScanDataTransfScreen(tracNo: data,)));
      print("=================");
                    ...
                    Container(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            'การทำธรุกรรม',
                            style: TextStyle(
                                color: Colors.pink, fontSize: _height * 0.025),
                          ),
                        )),
                    Container(
  ...
  Widget _buildHeaderInfo(BuildContext context, double _height, double _width) {
    return Container(
      padding: EdgeInsets.only(
          left: _height * 0.01, right: _height * 0.01, top: _height * 0.03),
      alignment: Alignment.centerLeft,
      width: _width * 0.6,
      height: _height * 0.16,
      child: Column(
        ...
        InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                color: name == "" ? Colors.transparent : Colors.pink[300]),
