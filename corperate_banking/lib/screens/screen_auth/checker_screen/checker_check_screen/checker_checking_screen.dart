...
class CheckerCheckingScreen extends StatefulWidget {
  @override
  _CheckerCheckingScreenState createState() => _CheckerCheckingScreenState();
}
...
class _CheckerCheckingScreenState extends State<CheckerCheckingScreen> {
              ...
              DialogButton(
                ...
                onPressed: () {
                  ...
                  Navigator.popAndPushNamed(
                      context, PageTo.checkerCheckOrderSuccessScreen);
                },
                width: 120,
              )
            ],
  ...
  Widget _buildButtonCancle(BuildContext context) {
    ...
    return Container(
      ...
      child: InkWell(
        onTap: () {
          Navigator.pushNamed(context, PageTo.checkerCheckNotPassReason);
