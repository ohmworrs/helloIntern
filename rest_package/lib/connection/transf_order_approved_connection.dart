...
class TransfOrderApprovedConnection extends AbstractConnection{

  TransfOrderApprovedConnection(String url, String port) : super(url, port);

  Future<http.Response> connectTransfOrderApproved(TransfOrderRequest request, String token){
    final endpoint = "mbp-rest/service/intMbpTxTransLogApp";
