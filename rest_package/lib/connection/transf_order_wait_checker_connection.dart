...
class TransfOrderWaitCheckerConnection extends AbstractConnection{

  TransfOrderWaitCheckerConnection(String url, String port) : super(url, port);

  Future<http.Response> connectTransfOrderWaitChecker(TransfOrderRequest request, String token){
    final endpoint = "mbp-rest/service/intMbpTxTransLogWaitCheck";
