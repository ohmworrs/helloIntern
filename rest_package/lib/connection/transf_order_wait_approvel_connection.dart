...
class TransfOrderWaitApprovelConnection extends AbstractConnection{

  TransfOrderWaitApprovelConnection(String url, String port) : super(url, port);

  Future<http.Response> connectTransfOrderWaitApprovel(TransfOrderRequest request, String token){
    final endpoint = "mbp-rest/service/intMbpTxTransLogWaitApp";
