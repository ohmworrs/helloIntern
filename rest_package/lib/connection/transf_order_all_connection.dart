...
class TransfOrderAllConnection extends AbstractConnection{

  TransfOrderAllConnection(String url, String port) : super(url, port);

  Future<http.Response> connectTransfOrderAll(TransfOrderRequest request, String token){
    final endpoint = "mbp-rest/service/intMbpTxTransLog";
